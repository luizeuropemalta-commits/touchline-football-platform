...
const API_POLICIES: Record<string, RoutePolicy> = {
  ...
  "GET /api/football-data/live-sync": { auth: "DISABLED", role: "NONE", data: "POST_ONLY", browser: "HTTP_405_CONTRACT", status: "METHOD_DISABLED" },
  "POST /api/football-data/live-sync": { auth: "QA_SCHEDULER_SECRET", role: "SERVER_JOB", data: "PROVIDER_TO_CANONICAL_LIVE_STATE", browser: "HTTP_CONTRACT", status: "HTTP_CONTRACT_PENDING" },
  "GET /api/football-data/foundation": { auth: "OWNER_OR_VALIDATION_SECRET", role: "OWNER_OR_SERVER_JOB", data: "OWNER_DIAGNOSTIC_ALLOWLIST", browser: "HTTP_CONTRACT", status: "HTTP_CONTRACT_PENDING" },
  ...
  "GET /api/touchline-social/share-art/[postId]": { auth: "PUBLIC", role: "ANY", data: "CURRENT_APPROVED_SOCIAL_ARTWORK_PROXY", browser: "MEDIA_HTTP_CONTRACT", status: "HTTP_CONTRACT_PENDING" },
  ...
  "PUT /api/touchline-arena/coach": { auth: "AUTHENTICATED_SAME_ORIGIN", role: "ARENA_USER", data: "SUPABASE_COACH_CONTRACT_HIRE", browser: "HTTP_CONTRACT", status: "HTTP_CONTRACT_PENDING" },
  "DELETE /api/touchline-arena/coach": { auth: "AUTHENTICATED_SAME_ORIGIN", role: "ARENA_USER", data: "SUPABASE_COACH_CONTRACT_END_WITH_HISTORY", browser: "HTTP_CONTRACT", status: "HTTP_CONTRACT_PENDING" },
