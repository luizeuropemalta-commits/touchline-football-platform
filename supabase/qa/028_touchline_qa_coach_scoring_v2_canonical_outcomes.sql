...
-- Canonical policy: home 3/1/0; away 4/2/0. Final settlements remain immutable.
...
comment on function public.touchline_reconcile_coach_fixture_points(uuid) is
  'QA-only canonical coach scoring: home 3/1/0 and away 4/2/0; final settlements immutable.';
