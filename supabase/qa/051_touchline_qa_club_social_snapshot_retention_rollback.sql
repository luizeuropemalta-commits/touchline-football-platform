-- QA-only rollback for 051. Restores the exact 050 reader-time source
-- currentness fence without deleting canonical posts or approval evidence.
...
begin
  if pg_catalog.to_regclass('public.touchline_club_social_posts') is null
    ...
    raise exception 'TL_SOCIAL_051_ROLLBACK_SCHEMA_PRECONDITION_FAILED';
  end if;
end
$$;
