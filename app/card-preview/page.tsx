...
function toPreviewPlayer(player: PlayerProfileRow): PlayerCardPreviewItem {
  return {
    ...
    age: player.age ? String(player.age) : "Data not available",
    ...
    updated: player.last_updated_at || player.updated_at || player.created_at || "Data not available",
...
export default async function CardPreviewPage() {
  ...
  if (!admin) {
    return <PlayerCardPreviewLab players={[]} />;
  }
  ...
  return <PlayerCardPreviewLab players={players} />;
}
