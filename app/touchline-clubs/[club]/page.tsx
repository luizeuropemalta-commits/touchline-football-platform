...
import {
  ...
  type TouchlineStadiumCatalogEntry,
} from "@/lib/touchlineArena/stadium-catalog";
import {
    ...
    <main className="club-hub" style={{ "--club-accent": club.accent, "--club-secondary": club.secondaryAccent, "--clubhub-accent": club.accent } as CSSProperties}>
      ...
      <style>{`
        ...
        @media (hover: hover) and (pointer: fine) {
          .club-hub-logo:hover,
          .club-hub-logo-stack:hover .club-hub-logo,
        ...
        @media (hover: none), (pointer: coarse) {
          ...
          .club-hub-logo-stack:active .club-hub-logo,
