...
export default async function CardEnginePage() {
  ...
  return <div className="mx-auto max-w-[1500px] space-y-6">
    <GamePanel className="overflow-hidden p-6 sm:p-8"><LivePill>QA only · protected editorial source</LivePill><h1 className="mt-5 max-w-4xl text-5xl font-black italic leading-[.9] text-white md:text-7xl">TouchLine Card Engine</h1><p className="mt-5 max-w-3xl text-sm leading-6 text-slate-300/75">Sportmonks owns football identity, facts and genuine transfers. TouchLine owns approved card presentation, editorial Market Value, tier calculation and audit provenance. Nothing publishes without explicit owner approval.</p><p className="mt-4 text-xs text-slate-500">Provider value → TouchLine override → effective value. Stale overrides are surfaced for review; raw football facts are not editable here.</p></GamePanel>
