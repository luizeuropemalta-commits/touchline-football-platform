      ...
      <div className="relative z-10 grid gap-8 xl:grid-cols-[1fr_420px] xl:items-end">
        <div>
          <div className="mb-5 flex flex-wrap items-center gap-3">
            <span className="inline-flex items-center gap-2 rounded-full border border-[#a3ff12]/25 bg-[#a3ff12]/[.08] px-3 py-1.5 text-[8px] font-black uppercase tracking-[.18em] text-[#b7ff45]"><span className="pulse-live size-1.5 rounded-full bg-[#a3ff12]"/>Market open</span>
            <span className="rounded-full border border-rose-300/20 bg-rose-300/[.07] px-3 py-1.5 text-[8px] font-black uppercase tracking-[.18em] text-rose-100">Window closes in 38 days</span>
          </div>
          <p className="af-mode-kicker">Main Menu / Live Negotiations</p>
          <h1 className="af-mode-title font-display mt-3 text-white">Transfer Window</h1>
          <p className="mt-5 max-w-2xl text-sm leading-7 text-slate-300/80">Bid wars, club pressure, urgent offers and market momentum — control the room and close the deal.</p>
          <div className="mt-8"><Button><Zap size={14}/>Start Negotiation</Button></div>
        </div>
        <div className="stadium-scoreboard p-5">
          <div className="relative z-10 flex items-center justify-between"><div><p className="text-[8px] font-black uppercase tracking-[.22em] text-[#a3ff12]">Window Heat</p><p className="font-display mt-2 text-7xl leading-none text-white">96</p></div><Flame className="text-rose-300" size={38}/></div>
