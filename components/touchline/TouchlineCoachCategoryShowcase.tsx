...
const copy = {
  "en-GB": {
    ...
    coachDescription: "Coach representatives follow the approved previous-season finish. The best official finish leads each tier and coach name is the final tiebreak when records are equal.",
  ...
  "pt-BR": {
    ...
    coachDescription: "Os representantes seguem a posição aprovada da temporada anterior. A melhor colocação oficial lidera cada tier e o nome do treinador é o último desempate quando os resultados são iguais.",
