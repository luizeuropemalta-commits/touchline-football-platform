...
const copy: Record<"en-GB" | "pt-BR", TableCopy> = {
  "en-GB": {
    ...
    pendingTitle: "Official standings will appear after the first verified final result.",
    pendingDescription: "No completed England fixture is currently available in the canonical TouchLine data source.",
  ...
  "pt-BR": {
    ...
    pendingTitle: "A tabela oficial aparecerá após o primeiro resultado final verificado.",
    pendingDescription: "Ainda não há partida concluída da England disponível na fonte canônica da TouchLine.",
