...
const copyByLocale: Record<TouchLinePresentationLocale, LaunchCopy> = {
  "pt-BR": {
    ...
    body: "Crie sua conta agora e seja um dos primeiros a entrar em campo quando a TouchLine abrir oficialmente. Estamos finalizando cada detalhe para entregar uma experiência verdadeiramente premium.",
  ...
  "en-GB": {
    ...
    body: "Create your account now and be among the first to step onto the pitch when TouchLine officially opens. We are refining every detail to deliver a truly premium experience.",
