...
const copy = {
  "pt-BR": {
    title: "Match Centre", live: "AO VIVO", today: "HOJE", upcoming: "PRÓXIMOS", finished: "ARQUIVO", matchweek: "Rodada", competition: "TouchLine England", select: "Confrontos", noFixtures: "Agenda em atualização", noFixturesCopy: "A programação oficial será exibida assim que a competição publicar fixtures canônicos.", venue: "Estádio", venuePending: "Aguardando confirmação oficial do estádio", countdown: "Início em", detail: "Dados da partida", dataPending: "Eventos, escalações e estatísticas aparecem assim que forem confirmados pela fonte oficial.", recent: "Últimos confrontos", form: "Forma recente", players: "Jogadores em destaque", archive: "Arquivo TouchLine", provider: "Dados oficiais sincronizados", timezone: "Horário local", versus: "VS", completed: "ENCERRADO", liveNow: "AO VIVO", next: "PRÓXIMO", official: "Fonte canônica", watch: "Acompanhar partida",
  },
  "en-GB": {
    title: "Match Centre", live: "LIVE NOW", today: "TODAY", upcoming: "UPCOMING", finished: "ARCHIVE", matchweek: "Matchweek", competition: "TouchLine England", select: "Fixtures", noFixtures: "Schedule updating", noFixturesCopy: "Official fixtures will appear as soon as the competition publishes the canonical schedule.", venue: "Stadium", venuePending: "Awaiting official venue confirmation", countdown: "Kick-off in", detail: "Match data", dataPending: "Events, line-ups and statistics appear as soon as the official provider confirms them.", recent: "Recent meetings", form: "Recent form", players: "Players to watch", archive: "TouchLine archive", provider: "Official data synced", timezone: "Local time", versus: "VS", completed: "FULL TIME", liveNow: "LIVE", next: "NEXT", official: "Canonical source", watch: "Open match",
  },
} as const;
