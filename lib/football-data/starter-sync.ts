    ...
    .upsert(
      {
        ...
        provider_position: player.broadPosition,
        provider_position_id: player.broadPositionId,
        detailed_position: player.detailedPosition,
        detailed_position_id: player.detailedPositionId,
    ...
    .upsert(
      {
        ...
        provider_position: member.broadPosition ?? member.player.broadPosition,
        provider_position_id: member.broadPositionId ?? member.player.broadPositionId,
        detailed_position: member.detailedPosition ?? member.player.detailedPosition,
        detailed_position_id: member.detailedPositionId ?? member.player.detailedPositionId,
        position: member.position ?? member.player.position,
        position_id: member.detailedPositionId ?? member.player.detailedPositionId,
        status: "active",
        source_updated_at: new Date().toISOString(),
      },
