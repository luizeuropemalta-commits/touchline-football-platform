...
const en: Record<TouchLineTranslationKey, string> = {
  ...
  ranking: "Ranking",
  choosePlayerPremiumCard: "Choose a player card to view the details and make a signing.",
  clubHub: "ClubHub",
  quickSubstitution: "Quick substitution",
  playerProfile: "PlayerProfile",
  clubProfile: "Club Profile",
  closePreview: "Close preview",
  marketCardPreview: "Player card details",
  edition: "Edition",
  ...
  selectPlayerCard: "Choose a player card to view its details.",
  walletBalance: "TC balance",
  marketCart: "Signings",
  cartEmpty: "Choose players to prepare their contracts",
  addToCart: "Sign player",
  ...
  rankingsDescription: "TouchLine Best XI, coach leaders and the sporting ClubOwner Table in one competitive destination.",
  rankingsShortcutDescription: "Best XI, coaches and the ClubOwner Table",
  openTables: "Open tables",
  cardRanking: "Card ranking",
  cardClubOwnerRank: "TouchLine Rankings",
  top20OwnerValue: "ClubOwner order follows competitive points only.",
  topCardsDescription: "Published accumulated TouchLine Rating controls the player-card order after each audited round.",
  club: "Club",
  allClubs: "All clubs",
  favorites: "Favorites",
  search: "Search",
  ...
  playerOrderDescription: "Player cards are ordered by accumulated verified TouchLine Rating, highest first.",
...
const ptBR: Record<TouchLineTranslationKey, string> = {
  ...
  ranking: "Ranking",
  choosePlayerPremiumCard: "Escolha um card para ver os detalhes e contratar o atleta.",
  clubHub: "ClubHub",
  quickSubstitution: "Substituição rápida",
  playerProfile: "PlayerProfile",
  clubProfile: "Club Profile",
  closePreview: "Fechar prévia",
  marketCardPreview: "Detalhes do atleta",
  edition: "Edição",
  ...
  selectPlayerCard: "Escolha um card para ver os detalhes do atleta.",
  walletBalance: "Saldo TC",
  marketCart: "Contratações",
  cartEmpty: "Escolha atletas para preparar os contratos",
  addToCart: "Contratar atleta",
  ...
  rankingsDescription: "TouchLine Best XI, líderes entre treinadores e a ClubOwner Table esportiva em uma única área competitiva.",
  rankingsShortcutDescription: "Best XI, treinadores e ClubOwner Table",
  openTables: "Abrir tabelas",
  cardRanking: "Ranking de cards",
  cardClubOwnerRank: "Rankings TouchLine",
  top20OwnerValue: "A ordem dos ClubOwners considera somente os pontos da competição.",
  topCardsDescription: "A Nota TouchLine acumulada e publicada comanda a ordem dos cards após cada rodada auditada.",
  club: "Clube",
  ...
  playerOrderDescription: "Os cards de jogadores são ordenados pela Nota TouchLine verificada acumulada, do maior para o menor.",
