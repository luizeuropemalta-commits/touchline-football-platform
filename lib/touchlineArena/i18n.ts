...
const en: Record<TouchLineTranslationKey, string> = {
  ...
  playerOrderDescription: "Player cards are ordered by accumulated valid Sportmonks Rating, highest first.",
...
const ptBR: Record<TouchLineTranslationKey, string> = {
  ...
  playerOrderDescription: "Os cards de jogadores são ordenados pelo Rating Sportmonks válido acumulado, do maior para o menor.",
