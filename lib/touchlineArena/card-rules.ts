...
export const TOUCHLINE_ARENA_MARKET_TIERS: TouchlineCardTier[] = [
  {
    key: "diamond-gold",
    label: canonicalTouchlineCardTierName("diamond-gold", "en-GB"),
  ...
  {
    key: "clear-diamond",
    label: canonicalTouchlineCardTierName("clear-diamond", "en-GB"),
  ...
  {
    key: "emerald-green",
    label: canonicalTouchlineCardTierName("emerald-green", "en-GB"),
  ...
  {
    key: "radiant-gold",
    label: canonicalTouchlineCardTierName("radiant-gold", "en-GB"),
  ...
  {
    key: "amethyst-purple",
    label: canonicalTouchlineCardTierName("amethyst-purple", "en-GB"),
  ...
  {
    key: "sapphire-blue",
    label: canonicalTouchlineCardTierName("sapphire-blue", "en-GB"),
  ...
  {
    key: "ruby-red",
    label: canonicalTouchlineCardTierName("ruby-red", "en-GB"),
