...
| 31 | Performance | IN_PROGRESS | production routes | — | required profiling | — | measure canonical public routes without altering product behavior |
| 31 | Performance | NOT_STARTED | production routes | — | required profiling | — | measure canonical public routes |
...
| 33 | Testing | IN_PROGRESS | suite | 617 passing | TypeScript/ESLint/unit/build | e2e/WebKit gaps | expand controlled e2e coverage |
