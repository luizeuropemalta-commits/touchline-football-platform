...
- **Premium hierarchy:** commit `803756da4a255a7a1b01d4f33a68692024cf438d` keeps the exact-position Best XI and adds exactly one full Top-1 coach card beside the pitch. The lower highlight area is intentionally limited to a three-card podium—Caoimhín Kelleher `7.73`, Jordan Pickford `7.55` and Antonín Kinský `7.11`—so it identifies gold, silver and bronze without duplicating the Best XI. The Top 7 coach table follows, then the sporting ClubOwner Table. No richest-ClubOwner/squad-value ranking is present.
...
- **Release/observability:** Preview `dpl_54wJsK5AyhxammjKZnB7DD77u95X` is `READY` for exact source `be2e65d06084044adeeef0afee88bc500e1741f0`, URL `https://touchline-arena-official-m3rj8b320-fifa-agent-plataform.vercel.app`, and owns the stable QA alias. Deployment-scoped error, fatal and `5xx` searches are empty. Production was not touched.
