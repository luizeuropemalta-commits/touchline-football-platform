...
| 2026-08-05 13:11 | Card assets and player identity | The local asset audit found all 140 card templates at the 430×691 standard with no colour/dimension failures or unexpected duplicate groups. The player-profile audit ran against the local production build on port 3124 and verified all 20 England clubs, 565 unique players, valid profile URLs and stable official identity resolution. | Local asset and identity pass | Repeat through native WebKit and controlled authenticated flows where applicable. |
...
- Card-asset audit: 140 official templates, no size/colour failures and no unexpected duplicate group. Player-profile audit: 20 clubs and 565 unique players passed with valid profile links and stable canonical identity.
